<?php
/**
 * Social Profile Buttons for Zikoko
 *
 * @package ZikokoTheme
**/
?>
...
<li class="facebook">
	<a href="http://facebook.com/zikokomag" target="_blank">
		<div class="icon"><?php include('icons/facebook.php'); ?></div> <span>Like Zikoko on Facebook</span>
	</a>
</li><!--
