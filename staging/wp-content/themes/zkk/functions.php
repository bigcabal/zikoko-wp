 ...
 *
 * Applies to:
 * 1. Latest Reviews & Latedt Posts sections
...
function ti_layout_based_post_image() {
	...
	if ( has_post_thumbnail() ) { // Set Featured Image
        ...
        echo '<img src="' . first_post_image() . '" class=attachment-masonry-size wp-post-image" itemprop="image" />';
    } else {
...
function register_theme_sidebars() {
	...
	if ( function_exists('register_sidebars') ) {
		...
		register_sidebar(
		   array(
			'name' => __( 'Banner', 'themetext' ),
			'id' => 'sidebar-0',
			'description'   => __( 'Banner', 'themetext' ),		   
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h3>',
			'after_title' => '</h3>',
		...
		register_sidebar(
		   array(
			'name' => __( 'Banner-Aside', 'themetext' ),
			'id' => 'sidebar-banner-aside',
			'description'   => __( 'Banner-Aside', 'themetext' ),		   
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h3>',
			'after_title' => '</h3>',
