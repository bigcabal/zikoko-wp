...
<?php get_header(); ?>
    ...
    ?>
      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php 
		// Display post media fullwidth
		if( $ti_option['single_media_position'] == 'fullwidth' ) { ?>
        <div class="entry-media">
            <?php 
            /**
             * Filter posts by selected post format
             * Output media from every post ( standard, gallery, video, audio )
            **/
        ...
        <div class="entry-media">
        	<?php
			// Display gallery full width even if "Above the Content" option was selected in ThemeOptions
        ...
        <?php endif; ?>
               ...
               <?php 
			   // Display post media Above the Content
			   ...
			   ?>
                <div class="single-box entry-media">
                    ...
                    /**
                     * Filter posts by selected post format
                     * Output media from every post ( standard, video, audio )
                    **/
					if ( ! get_post_format() ):
						get_template_part( 'formats/format', 'standard' );
					elseif ( 'video' == get_post_format() ): // Video
