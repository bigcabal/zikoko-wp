	...
	function ti_sp_array( $instance = array() ) {
		...
		return array(
			...
			'lastfm' => array(
				...
				'class' => __('lastfm', 'themetext'),
			),
			'app-net' => array(
				'title' => __('App.net', 'themetext'),
				'class' => __('app-net', 'themetext'),
			),
			'apple' => array(
				'title' => __('Apple', 'themetext'),
				'class' => __('apple', 'themetext'),
			),
			'windows' => array(
				'title' => __('Windows', 'themetext'),
				'class' => __('windows', 'themetext'),
			),
			'android' => array(
				'title' => __('Android', 'themetext'),
				'class' => __('android', 'themetext'),
			),
			'stumbleupon' => array(
				'title' => __('StumbleUpon', 'themetext'),
				'class' => __('stumbleupon', 'themetext'),
			),
			'picassa' => array(
				'title' => __('Picassa', 'themetext'),
				'class' => __('picassa', 'themetext'),
			),
			'skype' => array(
				'title' => __('Skype', 'themetext'),
				'class' => __('skype', 'themetext'),
			),
		);
	}
