...
if(function_exists("register_field_group"))
{
	...
	register_field_group(array (
		'id' => 'acf_post_sponsor1',
		'title' => 'Sponsor Details',
		'fields' => array (
			array (
				'key' => 'field_536f4b650028465',
					...
					array (
						...
						'sub_fields' => array (
							array (
								...
								'name' => 'ad_banner_code',
								'type' => 'textarea',
								'instructions' => 'Supports JS, AdSense, shortcodes, HTML or plain text.',
								'column_width' => '',
								'default_value' => '',
								'placeholder' => '',
								'maxlength' => '',
