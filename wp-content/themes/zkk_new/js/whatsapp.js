    ...
    WASHAREBTN.prototype.isIos = navigator.userAgent.match(/Android|iPhone/i) && !navigator.userAgent.match(/iPod|iPad/i) ? !0 : !1, WASHAREBTN.prototype.cntLdd = function(win, fn) {
        ...
        var s = document.createElement("style"),
            c = "body,html { 
	            ...
	            .wa_btn {
	            	background-image:url('http://zikoko.com/wp-content/uploads/2015/11/whatsapp-xxl.png');
	            ...
	            .social-share-buttons--floating .wa_btn_l {
        ...
        return i.width = 1, i.height = 1, i.button = b, i.style.border = 0, i.style.overflow = "visible", i.border = 0, i.setAttribute("scrolling", "no"), i.addEventListener("load", root.WASHAREBTN.iFrameOnload()), i
