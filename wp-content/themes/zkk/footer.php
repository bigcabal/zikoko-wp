...
?>
        ...
        <footer id="footer" class="no-print animated" role="contentinfo" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
        	...
        	<?php if ( $ti_option['footer_image_ad']['url'] == true || $ti_option['footer_code_ad'] == true ) { ?>
            ...
            <div class="copyright">
                <div class="wrapper">
                	<div class="grids">
                        <div class="grid-10">
                            <div class="bc-logo">
                                <a href="http://www.bigcabal.com/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/inc/bc-logo-white.png" alt="Big Cabal Logo"></a>
                            </div>
