jQuery(document).ready(function($) {
	...
	$('.quiz-checklist--submit').on('click', function() {
		...
		if ( numberOfChecked < 19 ) {
			...
			resultDescription = "In fact, are you sure you’re Nigerian? We would need to see your birth certificate, before we make our conclusions. You checked off "+numberOfChecked+" out of "+totalListItems+" on this list.";
			...
			resultDescription = "You’re a patriot and you love your country, but you’re not to randomly sing 'Arise o compatriots'. You checked off "+numberOfChecked+" out of "+totalListItems+" on this list.";
			...
			resultDescription = "You’re the Nigerian everyone wishes they were. You’re steady, passionate, and proud to be a Nigerian. You know the Nigerian dream is real because you’re living it every day. You checked off "+numberOfChecked+" out of "+totalListItems+" on this list.";
			...
			resultDescription = "You are Nigerian through and through and you’ll fight anyone who says otherwise. You get really excited when someone tells you 'You’re being very Nigerian right now.' You checked off "+numberOfChecked+" out of "+totalListItems+" on this list.";
