...
<li class="whatsapp post-share-btn" id="share-wa">
	...
	<a href="whatsapp://send" data-text="<?php echo $cleanTitle; ?> -" data-href="<?php echo $cleanPermalink; ?>?utm_source=wa%26utm_campaign=zkk_share" class="fawe-whatsapp wa_btn wa_btn_s"> <i class="fa fa-whatsapp"></i> </a>
