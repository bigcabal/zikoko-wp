...
<li class="whatsapp post-share-btn" id="share-wa">
	<a href="whatsapp://send" data-text="<?php echo $rawTitle; ?> -" data-href="<?php echo $rawPermalink; ?>?utm_source=wa&utm_campaign=zkk_share" class="fawe-whatsapp wa_btn wa_btn_l"> <i class="fa fa-whatsapp"></i> </a>
</li>
