...
function ti_theme_scripts(){
	...
	**/
	wp_register_script( 'ti-flexslider', get_template_directory_uri() . '/js/jquery.flexslider-min.js', 'jquery', '2.2.0', true );
	...
	**/
	...
	if(preg_match('/(?i)msie [6-9]/',$_SERVER['HTTP_USER_AGENT'])) { // if IE<=9
		wp_enqueue_script( 'ti-ie' , get_template_directory_uri() . '/js/oldie.js', '', '', true );
	}
