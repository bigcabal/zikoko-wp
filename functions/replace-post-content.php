    ...
    if (get_post_type($post_id) != 'acf' &&
        ...
        ';
            ...
            if ($media_choice === 'image') {
                ...
                if (!$raw_image && $raw_image_id) {
                    $raw_image = cl_image( $raw_image_id, 'in_post', true );
                }
       ...
       ************************ */
            elseif ($media_choice === 'embed') {
                ...
                switch ($embed_choice) {
                    case 'instagram':
                        $embed_url = get_post_meta($post_id, $this_content_block . '_embed_code_instagram', true);
                        $raw_embed = '[instagram_embed url="' . $embed_url . '"]';
                        break;
