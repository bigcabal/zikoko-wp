...
function my_show_extra_profile_fields( $user ) { ?>
  ...
  <table class="form-table">
    ...
    <tr>
      <th><label for="twitter">Profile Picture</label></th>

      <td>
        <input type="file" name="zkk_profile" id="zkk_profile" value="<?php echo esc_attr( get_the_author_meta( 'zkk_profile', $user->ID ) ); ?>" class="regular-image" /><br />
